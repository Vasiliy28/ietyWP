...
if(! function_exists('welcome_taxonomy')):
    function welcome_taxonomy(){
        $singular = 'Type post welcome';
        $plural = 'Type post welcoms';
        $slug = str_replace( ' ', '_', strtolower( $singular ) );
        $labels = array(
            'name'                       => $plural,
            'singular_name'              => $singular,
        ...
        register_taxonomy( $slug, 'welcome', $args );
    };
endif;

add_action('init','welcome_taxonomy');
